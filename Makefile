...
ldflags = -X github.com/cheqd/cosmos-sdk/version.Name=liquidityd \
		  -X github.com/cheqd/cosmos-sdk/version.AppName=liquidityd \
		  ...
		  -X github.com/cheqd/cosmos-sdk/types.reDnmString=[a-zA-Z][a-zA-Z0-9/:]{2,127}
